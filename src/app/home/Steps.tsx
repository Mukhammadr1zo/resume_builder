const STEPS = [
  { title: "PDF ni yuklang", text: "yoki scratch orqali yarating" },
  { title: "Dizaynni ko'rib chiqing", text: "va o'zgartiring" },
  { title: "Yangi rezyumeni yuklab oling", text: "va ishonch bilan murojaat qiling" },
];

export const Steps = () => {
  return (
    <section className="mx-auto mt-8 rounded-2xl bg-sky-50 bg-dot px-8 pb-12 pt-10 lg:mt-2">
      <h1 className="text-center text-3xl font-bold">Oddiy 3 qadam</h1>
